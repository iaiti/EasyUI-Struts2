...
<body>
	<table id="dg" title="My Users" class="easyui-datagrid"
		style="width: 700px; height: 500px" url="list_json" toolbar="#toolbar"
		rownumbers="true" fitColumns="true"  
		singleSelect ="false" checkbox="true" pagination="true"
		pageNumber ="1"
		>
		<thead>
			<tr>
	...
	<div id="dlg-buttons">
		<a  class="easyui-linkbutton" iconCls="icon-ok"
			onclick="saveUser()">保存</a> <a  class="easyui-linkbutton"
	...
	<div id="dlg2" class="easyui-dialog"
		...
		<form id="fm2" method="post">
			<div class="fitem">
				<label>name:</label> <input name="user" id="nameinput" class="easyui-validatebox"
					required="true" missingMessage="name不能为空">
			</div>
			<div class="fitem">
	...
	<div id="dlg-buttons">
		<a  class="easyui-linkbutton" iconCls="icon-ok"
			onclick="updateUser()">提交</a> <a  class="easyui-linkbutton"
